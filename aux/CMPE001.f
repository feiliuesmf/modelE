...
C**** NEWER VERSION THAT EXPECTS ARRAYS ON INDIVIDUAL RECORDS
     ...
     *     ,4)
      ...
      CHARACTER C*4,XLABEL*132,LABEL*16,FILEIN*60,HEADER*7
...
C****
      ...
      OPEN (1,FILE=FILEIN,FORM='UNFORMATTED',STATUS='OLD',ERR=810)
         ...
         READ (1) HEADER,TSFREZ1,DIAG1,TDIURN1,KEYNR 
         READ (1) TAU2

c      READ (1) TAU1,JC,C,RC,KEYNR,U1,V1,T1,P1,Q1,ODATA1,GDATA1,
c     *  GHDATA1,BLDATA1,PBL1,pblb1,ipbl1,CLOUD1,TMOM1,QMOM1,T501,RADN1,
c     *  TSFREZ1,DIAG1,TDIURN1,OA1,TAU2
...
C****
      ...
      OPEN (2,FILE=FILEIN,FORM='UNFORMATTED',STATUS='OLD',ERR=810)
         ...
         READ (2) HEADER,TSFREZ2,DIAG2,TDIURN2,KEYNR 
         READ (2) TAU2

c      READ (2) TAU1,JC,C,RC,KEYNR,U2,V2,T2,P2,Q2,ODATA2,GDATA2,
c     *     GHDATA2,BLDATA2,PBL2,pblb2,ipbl2,CLOUD2a,WM2,CLOUD2b,TMOM2
c     *     ,QMOM2,T502,RADN2,TSFREZ2,DIAG2,TDIURN2,OA2,TAU2
      IF (tau1.ne.tau2) then
...
c      else
      ...
      DAGPOS=DAGPOS+JM*94
      ERRQ=COMP8 ('RJ    ',24,94,1  ,DIAG1(DAGPOS),DIAG2(DAGPOS))
      DAGPOS=DAGPOS+24*94
