...
C****
      ...
      PARAMETER (IM=72,JM=46,LMO=13,J1O=4,JFMAX=13,NSEGM=6,INDM=90066
c      PARAMETER (IM=144,JM=90,LMO=13,J1O=7,JFMAX=25,NSEGM=10,INDM=941701
...
C****
      OPEN  (2,FILE='AVR72X46.9KY_nobs.L13b.modelE',FORM='UNFORMATTED')
     ...
     *        'Z72X46N_9KY_nobs, 13L, Lmin=2 '
      ...
      CLOSE (2)
      WRITE (6,*) 'Output written on unit 2:  ',TITLE
C****
