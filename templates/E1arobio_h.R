E1arobio_h.R GISS Model E  2007 modelE               aromanou 02/6/09
...
AIC=1JAN2000.rsfE3hyc0m             ! initial condition from Shan Sun's run (ISTART=5)
...
Label and Namelist:
E1arobio_h (ModelE 4x5, 20 lyrs, 1850 atm/ocn - frozen E1 version + 2deg hycom)
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=1900,MONTHE=01,DATEE=01,HOURE=00,     KDIAG=13*0,
