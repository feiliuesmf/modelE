E1arobiogasx.R GISS Model E  coupled version          aromanou   12/28/2008

E1arobiogasx: 2x2.5x40 layers modelE version, 1850 atm.; 32 layers in the ocean
          form (E1F40o32.R larissa   08/08/2008)
          NOTE: new ocean initial condition OIC=OIC.WOA98.2HX2.L32.D1201
          new new OIC=OIC.E2HX2.L32.D1201

E1F40o13: modelE1 (3.0) 4x5 hor. grid with 20 lyrs, top at .1 mb (+ 3 rad.lyrs)       
...
#define TRACERS_GASEXCH_ocean
#define TRACERS_GASEXCH_ocean_CO2
! #define SKIP_TRACER_SRCS 
...
components
!!!!!!!!!!!!!!!!!!! obio_rad  input data   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
CHL_DATA=CHL_WG_2x2.5                    !CHL_WG_4x5 in Gary'socean grid
                                         !to be used with CHL_from_SeaWIFs


Label and Namelist:
E1arobiogasx (32 ocean layers; 1850 atm.,the current modelE version)
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=2600,MONTHE=1,DATEE=1,HOURE=0, KDIAG=13*0,
