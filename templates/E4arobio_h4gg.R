E4arobio_h4gg.R GISS Model E  coupled version          tnl   05/17/2009

E4arobio_h4gg: 2x2.5x40 layers modelE version, 1850 atm.; 
...
AIC=1JAN2220.rsfEhTst        ! initial condition from Shan Sun's run (ISTART=5)
...
Label and Namelist:
E4arobio_h4gg (2x2.5x40, 1850 atm.;  1x1x26 HYCOM ocean)
...
itest=-1        ! (220,320) equator Atlant;   (316,258)=257.5E;-50.7S
...
atmCO2=280.0     !uatm for new preindustrial runs
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=2000,MONTHE=01,DATEE=01,HOURE=00, KDIAG=13*0,
   ISTART=5,IRANDI=0, YEARE=1800,MONTHE=01,DATEE=02,HOURE=00,IWRITE=1,JWRITE=1,
 &END
