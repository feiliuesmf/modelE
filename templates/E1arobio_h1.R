test5.R GISS Model E  1850 ocn/atm                 ssun 06/01/2009

test5: replace this section by a description of what distinguishes this run ?
...
Label and Namelist:
test5 (ModelE 2x2.5, 40 lyrs + 1deg hycom + pkpp_min(3/N,.3);[30:200])
