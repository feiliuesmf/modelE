E4arobio_h1.R GISS Model E  1850 ocn/atm             aromanou 08/10/2009

E4arobio_h1: E4hyf0d.R GISS Model E  1850 ocn/atm    ssun 06/01/2009  
       hycom+atmosphere+obio, gas exchange on ocean grid, based on E4hyf0d.R 
...
Label and Namelist:
E4arobio_h1 (ModelE 2x2.5, 40 lyrs + 1deg hycom + pkpp_min(3/N,.3);[30:200])
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   ISTART=2,IRANDI=0, YEARE=1800,MONTHE=1,DATEE=2,HOURE=1,
 &END
