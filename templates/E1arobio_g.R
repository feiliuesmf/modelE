E1arobio_g.R GISS Model E  coupled version          aromanou   12/28/2008

E1arobio_g: 2x2.5x40 layers modelE version, 1850 atm.; 32 layers in the ocean
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=2000,MONTHE=12,DATEE=2,HOURE=0, KDIAG=13*0,
   ISTART=2,IRANDI=0, YEARE=1900,MONTHE=12,DATEE=2,HOURE=0,IWRITE=1,JWRITE=1,
 &END
