E1arobio_tst.R GISS Model E  2007 modelE              aromanou 04/18/08

E1arobio_tst: obio + gas exch + radiation coupling 
...
Label and Namelist:
E1arobio_tst (ModelE 4x5, 20 lyrs, 1850 atm/ocn - frozen version + hycom)
