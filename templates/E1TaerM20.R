...
E1TaerM20: Sample rundeck with interactive mass aerosols
  including sulfate, sea salt, black and organic carbon
...
BC_BIOMASS=BC_GFED_1997-2006_4x5
OC_BIOMASS=OC_GFED_1997-2006_4x5
SO2_AIRCRAFT=NOy_sources/aircraft_4x5_1940-2000 ! zero in 1940 and before.
OC_INDh=OCh_IIASA_CLE_Nov08_4x5 !BC/OC are Bond to 1990, then IIASA for 2000-2030
BC_INDh=BCh_IIASA_CLE_Nov08_4x5
SO2_INDh=SO2h_IIASA_CLE2_Jan09_4x5 !SO2 is EDGAR to 1990, then IIASA for 2000-2030
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARI=1999,MONTHI=12,DATEI=1,HOURI=0, IYEAR1=1999 ! or earlier
   YEARE=1999,MONTHE=12,DATEE=2,HOURE=0,     
