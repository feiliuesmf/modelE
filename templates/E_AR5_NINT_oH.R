E_AR5_NINT_oH.R GISS Model E  coupled version          tnl   08/09/2010
...
E_AR5_NINT_oH : sibling E113F40oQ32.R  
...
E_AR5_NINT_oH (NIsurf=2; NetCDF output; WMUI_multiplier=2.; 1x1x26 HYCOM ocean)
