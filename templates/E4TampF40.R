...
TRACERS_AEROSOLS_Koch_e4            ! delete this line when #include "tracer_aerosols_source_files"
#include "tracer_AMP_source_files"
TRAMP_eqsam_v03d                    ! delete this line when #include "tracer_aerosols_source_files"
...
Terpenes_01=ORCHIDEE_Terpenes_1990_2x2.5_h ! delete this line when #include "chem_emiss_144x90_input_files"
...
COUPLED_CHEM=0     ! to couple chemistry and aerosols ! delete this line when #include "chemistry_params"
