SCMFASTER.R GISS Model E      awolf 03/2010   

SCM: RUN GISS Model E as SCM  using one latitude band                   
scm run using SGP March 2000 IOP Forcing Data  
...
SCM_COM SCMDATA_FASTER              ! routines for reading and processing SCM forcings and IC's
...
SCMSRF=SCM.SGP.surface_0003.dat   ! March 2000 IOP data
SCMLAY=SCM.SGP.layer_0003.dat     ! March 2000 IOP data

Label and Namelist:
SCMFASTER (ModelE 2x2.5, 40 lyrs, 1979 atm/ocn;
...
cloud_rad_forc=1 !use=0 to save cpu time (diagnostics doublds radiation calls!)
...
&&END_PARAMETERS
 ...
 &INPUTZ
   YEARI=2000,MONTHI=3,DATEI=1,HOURI=17, ! IYEAR1=YEARI (default) or earlier
   YEARE=2000,MONTHE=3,DATEE=22,HOURE=8,     KDIAG=12*0,9,
   ISTART=2,IRANDI=0, YEARE=2000,MONTHE=3,DATEE=4,HOURE=23,  !covers subset A
 &END
