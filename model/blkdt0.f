...
c --- 'acurcy' = permissible roundoff error in column integral calc.
      data diapyc/2.e-7/
      data h1/98060./,thkmin/5./,acurcy/1.e-11/,botmin/30./,kapref/0/
c
...
c
      data flnmlat/
     .   '/giss/cplinput/latlon195x180_20w.4bin'/
      data flnmdep/
     .   '/giss/cplinput/depth195x180_20w.4bin'/
      data flnmint/
     .   '/giss/cplinput/temp181x180x20jan_lt.asc'/
      data flnmins/
     .   '/giss/cplinput/salt181x180x20jan_lt.asc'/
      data flnminp/
     .   '/giss/cplinput/pout181x180x20jan_lt.asc'/
      data flnmbas/
     .   '/giss/cplinput/basinmasks.195x180'/
      data flnmkap/
     .   '/giss/cplinput/kap195x180_20w.4bin'/
