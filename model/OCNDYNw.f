...
#ifdef debug_1
      if(i==1.and.l==1) then
        write(0,*)'fy bef',fy(1,6:8,1)
        write(0,*)'f  bef',f(1,6:8,1)
        write(0,*)'s  bef',s(1,6:7,1)
        write(0,*)'sy bef',sy(1,6:7,1)
      end if
#endif
      DO n = J_0S, J_1S+1
         ...
         syn = sy(i,n,l)
#ifdef debug_2
            if(i==1.and.l==1.and.n<9.and.n>6)
     *         write(0,*) n,anm1,an,fnm1,fn,sn,syn
#endif
...
#ifdef debug_1
      if(i==1.and.l==1) then
        write(0,*)'fy aft',fy(1,6:8,1)
        write(0,*)'f  aft',f(1,6:8,1)
        write(0,*)'sy aft',sy(1,6:7,1)
      end if
#endif
