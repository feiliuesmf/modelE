...
!@+   entcells should be a slice without halo
     ...
     &     prescr_get_carbonplant, prescr_get_soil_C_total
      use ent_prescr_veg, only :
     &     prescr_veg_albedodata,
     &     prescr_get_hdata,prescr_get_woodydiameter,prescr_get_pop,
     &     prescr_get_crownrad,prescr_get_initnm,
     ...
     &        laidata,hdata,dbhdata,popdata,craddata,cpooldata)
      ...
      call prescr_get_soilpools(.true.,IM,JM,I0,I1,J0,J1,
     &      Tpool_ini)
#endif
