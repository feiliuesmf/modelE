hycom.R GISS Model E  coupled version      rar   8/31/2005

hycom: E3AoM20A + hycom kpp refinement
...
OCEAN_hycom|-r8 -openmp -O2|                                                 !ocean model
 hycom|-r8 -openmp -O2| advfct|-r8 -openmp -O2|    ape|-r8 -openmp -O2| archyb|-r8 -openmp -O2| barotp|-r8 -openmp -O2|      !ocean model
bigrid|-r8 -openmp -O2| blkdat|-r8 -openmp -O2| blkpp2|-r8 -openmp -O2| cnuity|-r8 -openmp -O2|  cpler|-r8 -openmp -O2|      !ocean model
dpthuv|-r8 -openmp -O2| dpudpv|-r8 -openmp -O2|   eic6|-r8 -openmp -O2| geopar|-r8 -openmp -O2| hybgn5|-r8 -openmp -O2|      !ocean model
inirfn|-r8 -openmp -O2| inigis|-r8 -openmp -O2| inikpp|-r8 -openmp -O2| matinv|-r8 -openmp -O2| momtum|-r8 -openmp -O2|      !ocean model
mxkprf|-r8 -openmp -O2| newbot|-r8 -openmp -O2| overtn|-r8 -openmp -O2| prtetc|-r8 -openmp -O2| reflux|-r8 -openmp -O1|      !ocean model
sigetc|-r8 -openmp -O2| sphdis|-r8 -openmp -O2| sstbud|-r8 -openmp -O2| thermf|-r8 -openmp -O2| trcadv|-r8 -openmp -O2|      !ocean model
tsadvf|-r8 -openmp -O2|  zebra|-r8 -openmp -O2|                                          !ocean model
hybrid_mpi_omp_renamer |-openmp -O2|
hybrid_mpi_omp_coupler |-openmp -O2|
...
Label and Namelist:
hycom (as E3r20p6, but difs/visc=.1/.3)
