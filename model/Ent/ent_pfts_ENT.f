...
!##### END OF TEMPORARY HACK #####
     ...
     &     1.2d0, 58.0d0, 50.d0, 0.2d0, 0.093d0, 1,.false.,
     ...
     &     1.2d0,25.0d0, 60.d0, 0.2d0, 0.153d0, 2,.false.,
     ...
     &     1.8d0, 27.0d0, 50.d0, 0.2d0, 0.2d0, 1,.false.,
     &     0.0240d0, 1.899d0, 0.1470d0, 2.238d0, 27.14d0, -0.0388d0),
     ! !* 9 - cold adapted shrub
     &     pftype(1,.true.,1,-153.d0,.50d0, .30d0, 1.4d0, 2.25d0, 0.6d0, 
     &     2.8d0, 5.5d0, 50.d0, 0.15d0, 1.40d0, 4,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 10 - arid adapted shrub
     &     pftype(1,.true.,1,-2030.d0,.40d0,.22d0, 1.3d0, 3.25d0, 0.6d0, 
     &     1.0d0, 5.5d0, 65.d0, 0.2d0, 0.32d0, 5,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 11 - C3 grass perennial
     &     pftype(1,.false.,3,-2030.d0,.30d0,.10d0,1.5d0, 10.0d0, 1.2d0, 
     &     1.5d0, UNDEF, 50.d0, 0.1d0, 0.0d0, 3,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 12 - C4 grass
     &     pftype(2,.false.,3,-2030.d0,.30d0,.10d0, 1.3d0,10.0d0, 0.6d0, 
     &     1.5d0, UNDEF, 50.d0, 0.1d0, 0.0d0, 3,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 13 - C3 grass - annual !## COPIED FROM C3 grass perennial
     &     pftype(1,.false.,3,-2030.d0,.30d0,.1d0, 1.5d0, 15.0d0, 1.2d0, !10->15  
     &     1.5d0, UNDEF, 50.d0, 0.1d0, 0.0d0, 3,.true.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 14 - arctic C3 grass
     &     pftype(1,.false.,3,-153.d0,.60d0, .27d0, 1.4d0, 9.0d0, 0.6d0, 
     &     1.5d0, UNDEF, 50.d0, 0.1d0, 0.0d0, 4,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 15 - C4 crops herbaceous
     &     pftype(2,.false., 1,-153.d0,.45d0,.27d0,1.3d0, 6.36d0, 0.6d0, 
     &     1.1d0, UNDEF, 52.5d0, 0.16d0, 0.0d0, 3,.false.,
     &     0.0800d0, 1.000d0, 0.00001d0, 1.000d0, 0.4778d0, -0.75d0),
     ! !* 16 - crops - broadleaf woody !## COPIED FROM BROAD COLDDECID LATE ##
     &     pftype(1,.true.,1,-153.d0,.50d0, .29d0, 1.4d0, 8.3d0, 0.9d0, 
     &     1.2d0, 58.0d0, 50.d0, 0.2d0, 0.093d0, 2,.false.,
     &     0.0170d0, 1.731d0, 0.2350d0, 2.252d0, 23.39d0, -0.0540d0)
     &     /)
