!@sum  RES_M14b Resolution info for 14 layer, 4x5 non-strat model
...
!@var LS1 Layers LS1->LM: constant pressure levels, L<LS1: sigma levels
      INTEGER, PARAMETER :: IM=72,JM=46,LM=14, LS1=11
...
!@var PLbot pressure levels at bottom of layers (mb)
     ...
     t     PSF, 964.d0, 934.d0, 884.d0, 810.d0, 710.d0, ! Pbot L=1,6
