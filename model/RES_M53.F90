!@sum RES_M53.F90   Resolution file, 4x5 Lat-Lon Grid, 53 layers, top at .20576514 Pa, GWDRAG
!@ver 2013/03/20
...
!@var LS1   = lowest layer of strtosphere
      Integer*4,Parameter :: IM=72,JM=46,LM=53, LS1=27
      Integer*4 :: L$
