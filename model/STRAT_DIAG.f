...
CW      SCALE = 1.E6
CW      CALL WRITJL ('DUDT: MEAN EULER',DMF,SCALE)
CW      CALL WRITJL ('DUDT: EDDY EULER',DEF,SCALE)
CW      CALL WRITJL ('DUDT: EULER CIRC',DUD,SCALE)
CW      CALL WRITJL ('DUDT: MEAN TRANS',DMFR,SCALE)
CW      CALL WRITJL ('DUDT: EDDY TRANS',DEFR,SCALE)
CW      CALL WRITJL ('DUDT: TRANS-EULE',DUR,SCALE)
      RETURN
      END
