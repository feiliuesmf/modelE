...
C****
     ...
     *     ,EVHDT,F1DT,DO3600NG,CM,CH,CQ,DHGS,DQGS,DGS,BETAUP,EVHEAT,F0
     ...
     *     ,TG1,SRHEAT,SNOW,TG2,SHDT,TRHDT,DO3600NG,TG,TS,RHOSRF,RCDMWS
...
C*
      ...
      END DO
c  30 S0=S0X*1367./RSDIST   !obsolete
...
c ADAILY(IHOUR,1,KR)=ADAILY(IHOUR,1,KR)+S0*COSZ1(I,J) !now in RADIA
