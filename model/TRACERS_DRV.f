...
c gravitational settling of ss2
        ...
        k=k+1
          ...
          sname_jls(k)=trname(n)//'_emission'
          jls_ltop(k)=1
          jls_power(k)=1
          units_jls(k)=unit_string(jls_power(k),'kg/s')
        k=k+1
          ...
          sname_jls(k)=trname(n)//'_turb_depo'
          jls_ltop(k)=1
          jls_power(k)=1
          units_jls(k)=unit_string(jls_power(k),'kg/s')
        k=k+1
          ...
          sname_jls(k)=trname(n)//'_grav_settle'
          jls_ltop(k)=Lm
          jls_power(k)=1
          units_jls(k)=unit_string(jls_power(k),'kg/s')
        k=k+1
          ...
          sname_jls(k)=trname(n)//'_wet_depo'
          jls_ltop(k)=Lm
          jls_power(k)=1
          units_jls(k)=unit_string(jls_power(k),'kg/s')
#endif
...
c ss2 optical thickness
      ...
      k=k+1
        ...
        sname_ijts(k)=trname(n)//'_emission'
        ijts_index(k)=n
        ia_ijts(k)=ia_src
        ijts_power(k) = -13.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
      ...
      k=k+1
        ...
        sname_ijts(k)=trname(n)//'_turb_depo'
        ijts_index(k)=n
        ia_ijts(k)=ia_src
        ijts_power(k) = -13.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
      ...
      k=k+1
        ...
        sname_ijts(k)=trname(n)//'_grav_settle'
        ijts_index(k)=n
        ia_ijts(k)=ia_src
        ijts_power(k) = -13.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
      ...
      k=k+1
        ...
        sname_ijts(k)=trname(n)//'_wet_depo'
        ijts_index(k)=n
        ia_ijts(k)=ia_src
        ijts_power(k) = -13.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
