...
C**** 3D tracer-related arrays but not attached to any one tracer
      ...
      k = k + 1
        ...
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_apartmass_isopp1a=k
        lname_ijlt(k) = 'Effective apartmass of isopp1a'
        sname_ijlt(k) = 'SOA_apartmass_isopp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_apartmass_isopp2a=k
        lname_ijlt(k) = 'Effective apartmass of isopp2a'
        sname_ijlt(k) = 'SOA_apartmass_isopp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        sname_ijlt(k) = 'SOA_apartmass_apinp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_apartmass_apinp2a=k
        lname_ijlt(k) = 'Effective apartmass of apinp2a'
        sname_ijlt(k) = 'SOA_apartmass_apinp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
      ...
      k = k + 1
        ...
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_kp_isopp1a=k
        lname_ijlt(k) = 'Partitioning coefficient of isopp1a'
        sname_ijlt(k) = 'SOA_kp_isopp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'m3/ug')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_kp_isopp2a=k
        lname_ijlt(k) = 'Partitioning coefficient of isopp2a'
        sname_ijlt(k) = 'SOA_kp_isopp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'m3/ug')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        sname_ijlt(k) = 'SOA_kp_apinp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'m3/ug')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_kp_apinp2a=k
        lname_ijlt(k) = 'Partitioning coefficient of apinp2a'
        sname_ijlt(k) = 'SOA_kp_apinp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'m3/ug')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_soamass_isopp1a=k
        lname_ijlt(k) = 'Potential SOA mass'
        sname_ijlt(k) = 'SOA_soamass_isopp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'ug/m3')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_soamass_isopp2a=k
        lname_ijlt(k) = 'Potential SOA mass'
        sname_ijlt(k) = 'SOA_soamass_isopp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'ug/m3')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        lname_ijlt(k) = 'Potential SOA mass'
        sname_ijlt(k) = 'SOA_soamass_apinp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'ug/m3')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_soamass_apinp2a=k
        lname_ijlt(k) = 'Potential SOA mass'
        sname_ijlt(k) = 'SOA_soamass_apinp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'ug/m3')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        sname_ijlt(k) = 'SOA_partfact_isopp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_partfact_isopp2a=k
        lname_ijlt(k) = 'Final partfact value'
        sname_ijlt(k) = 'SOA_partfact_isopp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ...
        lname_ijlt(k) = 'Final partfact value'
        sname_ijlt(k) = 'SOA_partfact_apinp1a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
        ijlt_soa_partfact_apinp2a=k
        lname_ijlt(k) = 'Final partfact value'
        sname_ijlt(k) = 'SOA_partfact_apinp2a'
        ijlt_power(k) = 0
        units_ijlt(k) = unit_string(ijlt_power(k),'dimensionless')
        scale_ijlt(k) = 10.**(-ijlt_power(k))
      k = k + 1
