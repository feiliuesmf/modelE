...
C***********************************************************************  
C  REVISION HISTORY:                                                   *        
C   Modified by Yang Zhang of AER in Sept., 2001 to incorporate the CMU*        
C           hybrid mass transfer module into MADRID1                   *        
C           The code for the CMU hybrid mass transfer module was       *        
C           provided by Bonyoung Koo/Spyros Pandis of CMU on           * 
C           May 18, 2001                                               * 
C                                                                      * 
C*********************************************************************** 
      INCLUDE 'aero_isrpia.ext'
      DIMENSION WI(NCOMP)
C
