E3arobio.R GISS Model E  coupled version      aromanou 4/13/2007

E3arobio: from E3arBio : E3hyc03 (ssun) + ocean biology no gas exchange
...
#define TRACERS_restart_Natassa
...
!!AIC=1JAN1820.rsfE3b20t1
!!AIC=1JAN1801.rsfE3arBio_ngx    !restart from my 1yr run
AIC=1JAN1850.rsfE3a20t2_tr15n    !restart from Shana's 50yr run -mod for 15trcrs and modelEtrdiag
CDN=CD4X500S.ext
...
oasimdirect=oasimdirect_20w  !
atmFedirect=atmFedirect_20w  !
facirr=facirr.asc            !

Label and Namelist:
E3arobio (obio+gasexc CO2;hycoma+tsadts: bihar=.1,hybgn1,pump[20:200],part.kppx3,enh.den,no conv)
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=2100,MONTHE=01,DATEE=01,HOURE=00, KDIAG=13*0,
   ISTART=8,IRANDI=0,YEARE=1800,MONTHE=01,DATEE=02,HOURE=00
 &END
link_ha_feb07
