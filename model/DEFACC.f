...
c
      ...
      lname_ij(k) = 'SNOW MASS'    ! 'SNOW DEPTH'
      units_ij(k) = 'kg/m^2'
      name_ij(k) = 'SNOW'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      ...
      lname_ij(k) = 'VEGETATED SOIL WETNESS DUE TO ROOTS'
      units_ij(k) = '%'
      name_ij(k) = 'BETA'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.
...
c
      ...
      lname_ij(k) = 'MOIST CONVECTIVE CLOUD COVER'
      units_ij(k) = '%'
      name_ij(k) = 'PMCCLD'
      ia_ij(k) = ia_rad
      scale_ij(k) = 100.
...
c
      ...
      lname_ij(k) = 'TOTAL NORTH TRANS OF DRY STATIC ENERGY'
      units_ij(k) = '10^14 W'
      name_ij(k) = 'PEV'
      ia_ij(k) = ia_dga
...
c
      ...
      lname_ij(k) = 'NET RADIATION AT SURFACE'
      units_ij(k) = 'W/m^2'
      name_ij(k) = 'SRTR'
      ia_ij(k) = ia_src
      scale_ij(k) = 1./DTsrc
c
      ...
      lname_ij(k) = 'NET SURFACE HEATING'
      units_ij(k) = 'W/m^2'
      name_ij(k) = 'NETH'
      ia_ij(k) = ia_src
      scale_ij(k) = 1./DTsrc
...
c
      ...
      lname_ij(k) = 'TROPOSPHERIC STATIC STABILITY'
      units_ij(k) = 'degC/km'
      name_ij(k) = 'DTDP'
      ia_ij(k) = ia_dga
...
c
      ...
      lname_ij(k) = 'SURFACE RUNOFF OVER SOIL'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'RUNE'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
...
c
      ...
      lname_ij(k) = 'MID LEVEL CLOUD COVER'
      units_ij(k) = '%'
      name_ij(k) = 'PCLDM'
      ia_ij(k) = ia_rad
      scale_ij(k) = 100.
...
c
      ...
      lname_ij(k) = 'BRIGHTNESS TEMPERATURE IN WINDOW REGION'
      units_ij(k) = 'degC'
      name_ij(k) = 'BTMPW'
      ia_ij(k) = ia_rad
      scale_ij(k) = 1.
c
      ...
      lname_ij(k) = 'ABSORBED SOLAR RADIATION IN VISUAL'
      units_ij(k) = 'W/m^2'
      name_ij(k) = 'SRREF'
      ia_ij(k) = ia_rad
      scale_ij(k) = 1.
...
c
      ...
      lname_ij(k) = 'TOTAL WATER AND ICE OVER SOIL'
      units_ij(k) = 'kg/m^2'
      name_ij(k) = 'GWTR'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      ...
      lname_ij(k) = 'EVAPORATION x POCEAN'
      units_ij(k) = 'mm/day %'
      name_ij(k) = 'EVAPO'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.*SDAY/DTsrc
c
      k=k+1 !  'AIJ062'
      IJ_EVAPI = k ! EVAP*POICE  (KG/M**2)                   1 GD
      lname_ij(k) = 'EVAPORATION x POICE'
      units_ij(k) = 'mm/day %'
      name_ij(k) = 'EVAPI'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.*SDAY/DTsrc
c
      ...
      lname_ij(k) = 'EVAPORATION x PLICE'
      units_ij(k) = 'mm/day %'
      name_ij(k) = 'EVAPLI'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.*SDAY/DTsrc
c
      ...
      lname_ij(k) = 'EVAPORATION x PSOIL'
      units_ij(k) = 'mm/day %'
      name_ij(k) = 'EVAPE'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.*SDAY/DTsrc
...
c
      ...
      lname_ij(k) = 'DEEP CONVECTIVE CLOUD OCCURRENCE'
      units_ij(k) = '%'
      name_ij(k) = 'DCNVFRQ'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.
c
      ...
      lname_ij(k) = 'SHALLOW CONVECTIVE CLOUD OCCURRENCE'
      units_ij(k) = '%'
      name_ij(k) = 'SCNVFRQ'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.
...
c
      ...
      lname_ij(k) = 'Wind Reduction Rate by strat. drag'
      units_ij(k) = 'm/s/s'
      name_ij(k) = 'SDRAG'
      ia_ij(k) = ia_src
      scale_ij(k) = 1./DTsrc
...
c
      k=k+1
      name_jl(k) = 'mc_mflx' !'AJL08'
      lname_jl(k) = 'VERTICAL MASS EXCHANGE FROM MOIST CONVECTION' !'FMX(MC)*P'
...
c
      k=k+1
      name_jl(k) = 'del_am_mc' !'AJL39'
      lname_jl(k) = 'CHANGE OF ANG. MOMENTUM BY MOIST CONV' !'DU(MC)*P (UV GRID)'
...
c
      k=k+1
      name_jk(k) = 'dp_cp' !'AJK02'
      lname_jk(k) = 'PRESSURE DIFFERENCES (CP)' !'DP4  (PDN-PM(K+1))   (UV GRID)'
      units_jk(k) = 'MB'
      scale_jk(k) = byim
      ia_jk(k) = ia_dga
      jgrid_jk(k) = 2
