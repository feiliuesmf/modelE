...
#if defined(ENT_STANDALONE_DIAG)
  logical, parameter :: ent_standalone_diag = .true.
#else
  logical, parameter :: ent_standalone_diag = .false.
#endif
...
#else
  logical, parameter :: pft_model_ent = .false.
#endif
...
#if defined(USE_ENT)
  logical, parameter :: use_ent = .true.
#else
  logical, parameter :: use_ent = .false.
#endif
