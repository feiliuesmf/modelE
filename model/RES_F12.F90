!@sum RES_F12.F90   Resolution file, 2x2.5 Lat-Lon Grid, 12 layers, top at 10 mb, non-strat model
...
!@var LS1   = lowest layer of strtosphere
      Integer*4,Parameter :: IM=144,JM=90,LM=12, LS1=9
...
!****     9  509.9    0        0.0  509.9             0.0  509.9
!****     8    0.0  60/834   611.8  611.8  1529.6   305.9  305.9  1529.6
!****     7    0.0  75/834
!****
!****     3    0.0 134/834
!****     2    0.0  80/834
