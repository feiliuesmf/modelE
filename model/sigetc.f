...
c - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
c     sdif=max(30.,min(38.,s))-refsal
c     tdif=max(-2.,min(32.,t))-reftem
css   prs=max(pres,200.*onem)			!  experimental
c     kappaf=exp(sclkap * (tdif*(qt+tdif*(qtt+tdif*qttt)
c    .       +.5*(prs+pref)*(qpt+sdif*qpst+tdif*qptt))
c    .       +sdif*(qs+tdif*qst))*(prs-pref)) - 1.
c - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
