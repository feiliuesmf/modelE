E3oHYC.R GISS Model E  coupled version      rar   11/10/2004

E3oHYC: E3PIAoM20A.R + hycom

modelE1 (3.0) 4x5 hor. grid with 20 lyrs, top at .1 mb (+ 3 rad.lyrs)
atmospheric composition from year 1850
ocean: coupled to HYCOM Version 0.9.1
...
bigrid|-r8| blkdat|-r8| cnuity|-r8| convec|-r8| diapfl|-r8|      !ocean model
dpthuv|-r8| dpudpv|-r8|   eice|-r8| findmx|-r8| geopar|-r8|      !ocean model 
getdat|-r8| hybgen|-r8| inicon|-r8| linout|-r8|  cpler|-r8|      !ocean model 
momtum|-r8| mxlayr|-r8| newbot|-r8| overtn|-r8|   pipe|-r8|      !ocean model
prtmsk|-r8|  psmoo|-r8| reflux|-r8| sigetc|-r8| sphdis|-r8|      !ocean model 
stencl|-r8| sstbud|-r8| thermf|-r8| tsadvc|-r8|  zebra|-r8|      !ocean model
tnl_checksum_mod  ! TNL
select_array_mod  ! TNL
...
!AIC=AIC/1JAN1941.rsfE3AoM20A    ! full IC (GIC,OIC not needed) ISTART=8 (spun up 380 yrs)
CDN=CD4X500S.ext
...
Label and Namelist:
E3oHYC (E3PIAoM20A.R coupled to hycom 0.9.1 with volc aerosols)
...
&&END_PARAMETERS
 ...
 &INPUTZ
   ...
   YEARE=1800,MONTHE=1,DATEE=5,HOURE=0, KDIAG=13*0,
