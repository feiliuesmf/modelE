...
Label and Namelist:
E001TdsM23 (modelE 2.3.4+ strat version with tropospheric chemsitry)
R=00BG/B
...
KOCEAN=0
U00ice=.70   ! tune this first to get reas.alb/cldcvr (range: .4-.6), then
HRMAX=397.   ! tune this to get rad.equilibrium (range: 100.-1500. meters)
